...
public interface UBNAccountAPIService {
    ...
    Call<UBNGetAccountsResponse> getAccountsByMobileNumber(@Header("Authorization") String token, @Header("ChannelCode") String channelCode, @Body UBNGetAccountsRequest request );
}
