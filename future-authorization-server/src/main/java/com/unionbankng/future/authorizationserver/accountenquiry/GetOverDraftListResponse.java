 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service.unionbank.com/}overdraftList" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetOverDraftListResponse {
    ...
    protected List<OverdraftList> _return;
     ...
     * 
     */
    public List<OverdraftList> getReturn() {
        if (_return == null) {
            _return = new ArrayList<OverdraftList>();
        }
        return this._return;
    }
