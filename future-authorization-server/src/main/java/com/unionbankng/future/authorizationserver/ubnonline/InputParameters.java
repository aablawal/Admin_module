...
public class InputParameters {
    ...
    @XmlElementRef(name = "BVN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/newibankbvn", type = JAXBElement.class, required = false)
    protected JAXBElement<String> bvn;
     ...
     *     
     */
    public JAXBElement<String> getBVN() {
        return bvn;
    }
     ...
     *     
     */
    public void setBVN(JAXBElement<String> value) {
        this.bvn = value;
    }
