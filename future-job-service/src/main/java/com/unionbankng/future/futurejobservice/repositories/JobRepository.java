...
public interface JobRepository extends JpaRepository<Job,Long> {
    ...
    @Query(value = "SELECT * FROM jobs j where j.type=:type and j.category=:category and (j.status='AC' or (j.status='WP' and j.type='TEAMS_PROJECT')) order by id desc", nativeQuery = true)
